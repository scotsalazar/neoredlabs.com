...
/**
 * Footer component containing contact details and social links.  All
 * email addresses use the neolabs.com domain to reflect the new
 * branding.  Social profiles have been updated accordingly.
 */
  ...
  <footer className="bg-dark py-12 text-white">
    <div className="section-container">
      ...
      <p className="mt-10 border-t border-white/10 pt-6 text-center text-xs md:text-sm">
        © {new Date().getFullYear()} Neo&nbsp;Labs. All rights reserved.
      </p>
    </div>
  </footer>
);
