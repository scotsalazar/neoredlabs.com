...
const services = [
  {
    ...
    description: 'Eliminate redundant tasks using customised AI workflows tailored to your teams.',
    icon: (
  ...
  },
  {
    ...
    description: 'Seamlessly connect your systems with intelligent automation and event-driven flows.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none">
  ...
  },
  {
    ...
    description: 'Unify data, APIs, and partner tools to deliver cohesive customer experiences.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none">
  ...
  },
  {
    ...
    description: 'Monitor performance with live dashboards, AI insights, and automated alerts.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none">
  ...
  },
  {
    ...
    description: 'Automate processes end-to-end with resilient orchestration and human-in-the-loop controls.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none">
